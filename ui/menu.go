...
var keyStyle = lipgloss.NewStyle().Foreground(TextSecondary)

var descStyle = lipgloss.NewStyle().Foreground(TextSecondary)

var sepStyle = lipgloss.NewStyle().Foreground(SeparatorLine)

var actionGroupStyle = lipgloss.NewStyle().Foreground(ActionGroup)
